                    ...
                    <div class="blog-grid-top">
                        <div class="b-grid-top">
                            <div class="blog_info_left_grid">
                                <a href="single.html">
                                    <img src="<?php echo base_url('asset/backend/fileman/Uploads/Images/Artikel/'.$artikel->gambar_artikel) ?>" class="img-fluid" width="100%" alt="">
                                </a>
                            </div>
                        ...
                        <h3><a href="#"><?php echo $artikel->nama_artikel ?></a></h3>
                        <p><?php echo $artikel->konten_artikel ?></p>
                    </div>
                </div>
                <!--//left-->
