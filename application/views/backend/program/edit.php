            ...
            <section class="content">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-body">
                                    <form class="form-horizontal" action="<?php echo site_url('program/update/'.$program->id_program) ?>" method="POST" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label for="txt_nama" class="col-md-2 control-label">Name Article</label>
                                        <div class="col-md-10">
                                            <input type="text" name="txt_nama" id="txt_nama" class="form-control" value="<?php echo $program->nama_program ?>"> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <br>
                                            <img width="200" height="180" src="<?php echo base_url('asset/backend/fileman/Uploads/Images/Program/'.$program->gambar_program) ?>""><br>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <textarea name="txt_deskripsi" id="txt_deskripsi" cols="30" rows="10" class="form-control"><?php echo $program->deskripsi_program ?></textarea>
                                        </div>
                                    </div>
