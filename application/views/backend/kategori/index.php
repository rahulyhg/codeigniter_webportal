...
<body class="hold-transition skin-blue sidebar-mini">
        ...
        <div class="content-wrapper">
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="#"><i class="fa fa-th-list"></i> Category</a></li>
                </ol>
            </section>
    ...
    <?php $this->load->view('backend/kategori/form') ?>
    ...
    <script type="text/javascript">
    	...
    	$(document).ready(function() {
    		table = $('.table').DataTable({
                ...
                "serverside" : true,
                "ajax" : {
                    "url" : "<?php echo site_url('kategori/data') ?>",
                    "type" : "GET"
                }
            });
            ...
            $('#modal-form').on('submit', function (e) {
                if (!e.isDefaultPrevented()) {
                    ...
                    var id_kategori = $('#txt_id').val();

                    if (save_method == "add") url = "<?php echo site_url('kategori/insert') ?>";
                    else url = "kategori/update/"+id_kategori;
    	...
    	function editForm(id) {
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    $('#txt_id').val(data.id_kategori);
                    $('#txt_name').val(data.name_kategori);
                },
                error: function(){
