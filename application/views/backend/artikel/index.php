                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <a href="<?php echo site_url('artikel/create') ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Create New</a>
                            </div>
                            <div class="box-body">  
                                <table class="table table-hover tablesorter">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="header">Name Article</th>
                                            <th class="header">Category</th>
                                            <th class="header">Image Article</th>
