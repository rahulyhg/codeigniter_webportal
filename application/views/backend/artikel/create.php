                            ...
                            <div class="box">
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <select name="txt_kategori" id="txt_kategori" class="form-control" required>
                                                <option value=""></option>
                                                <?php foreach ($kategoris as $kategori): ?>
                                                <option value="<?php echo $kategori->id_kategori ?>"><?php echo $kategori->name_kategori ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="box">
                                <div class="box-body">  
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="txt_name" id="txt_name" class="form-control" autofocus required> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <textarea name="txt_konten" id="txt_konten" cols="30" rows="10" class="form-control"></textarea>
                                        </div>
                                    </div>
