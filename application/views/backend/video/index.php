...
<body class="hold-transition skin-blue sidebar-mini">
        ...
        <div class="content-wrapper">
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="#"><i class="fa fa-th-list"></i> video</a></li>
                </ol>
            </section>
                                ...
                                <table class="table table-hover tablesorter">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="header">Name video</th>
                                            <th class="header">Slug</th>
                                            <th class="header">Playlist</th>
    ...
    <?php $this->load->view('backend/video/form') ?>
    ...
    <script type="text/javascript">
    	...
    	$(document).ready(function() {
    		table = $('.table').DataTable({
                ...
                "serverside" : true,
                "ajax" : {
                    "url" : "<?php echo site_url('video/data') ?>",
                    "type" : "GET"
                }
            });
            ...
            $('#modal-form').on('submit', function (e) {
                if (!e.isDefaultPrevented()) {
                    ...
                    var id_video = $('#txt_id').val();

                    if (save_method == "add") url = "<?php echo site_url('video/insert') ?>";
                    else url = "video/update/"+id_video;
    	...
    	function editForm(id) {
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    $('#txt_id').val(data.id_video);
                    $('#txt_nama').val(data.nama_video);
                    $('#txt_playlist').val(data.playlist_id);
                    $('#txt_konten').val(data.konten_video);
                },
                error: function(){
